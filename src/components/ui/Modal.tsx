  ...
  return (
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-1/2 left-1/2 w-[calc(100vw-2rem)] max-w-lg z-[151] -translate-x-1/2 -translate-y-1/2 card-glass p-6 animate-scale-in sm:p-7">
