    ...
    <header className="hero">
      <div className="hero-content">
        ...
        <h1 className="hero-title">
          Developer <span className="text-accent">Workspace</span>
        </h1>
        <p className="hero-subtitle">
          A customizable new tab page with smart bookmarks, productivity tools,
          and everything you need to stay in the flow.
        </p>
